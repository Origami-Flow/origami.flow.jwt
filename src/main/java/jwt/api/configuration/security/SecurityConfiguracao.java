package jwt.api.configuration.security;

import jakarta.servlet.Filter;
import jwt.api.configuration.security.jwt.GerenciadorTokenJwt;
import jwt.api.service.usuario.autenticacao.AutenticacaoService;
...
public class SecurityConfiguracao {
    ...
    private static final AntPathRequestMatcher[] URLS_PERMITIDAS = {
            ...
            new AntPathRequestMatcher("/auth/cadastro"),
            new AntPathRequestMatcher("/auth/login/trancista"),
            new AntPathRequestMatcher("/auth/login/cliente"),
    };
